...
import ibm_db
import bcrypt
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=6667d8e9-9d4d-4ccb-ba32-21da3bb5aafc.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;PORT=30376;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;PROTOCOL=TCPIP;UID=qtx10414;PWD=jMIXi3MGbJcaYc5E",'','')
...
def register():
  if request.method == 'POST':
    ...
    if not isUser:
      insert_sql = "INSERT INTO USER(EMAIL, USERNAME, PASSWORD, ROLLNO) VALUES (?,?,?,?)"
