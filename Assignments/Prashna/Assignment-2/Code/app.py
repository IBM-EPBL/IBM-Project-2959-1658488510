...
import ibm_db
import bcrypt
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=b70af05b-76e4-4bca-a1f5-23dbb4c6a74e.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;PORT=32716;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;PROTOCOL=TCPIP;UID=nnj28044;PWD=v1exVH0WbtfErcyA",'','')


# url_for('static', filename='style.css')

app = Flask(__name__)
app.secret_key ='DEg3Vvv8D3VR2y9VK39'
...
def register():
  if request.method == 'POST':
    ...
    if not isUser:
      insert_sql = "INSERT INTO USER(USERNAME, UEMAIL, UPASSWORD, ROLLNUMBER) VALUES (?,?,?,?)"
